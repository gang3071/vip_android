...
import com.timego.calculcator.databinding.ActivityMain2GameBinding;
...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setNavigationBarColor(Color.parseColor(MainActivity.getString(GameActivity.this, "style_color", "#000000")));
        getWindow().getDecorView().setBackgroundColor(Color.parseColor(MainActivity.getString(GameActivity.this, "windows_color", "#000000")));
...
//                WidgetUtils.showToast(JsBridgeActivity.this, "未知错误", WidgetUtils.ToastType.ERROR);
                Toast.makeText(GameActivity.this, "未知错误", Toast.LENGTH_SHORT).show();
                return false;
            }
            return true;
        }
                    ...
                    public void run() {
                        for (String permisson : request.getResources()) {
                            ...
                            if (permisson.equals(PermissionRequest.RESOURCE_VIDEO_CAPTURE)) {
                                if (ContextCompat.checkSelfPermission(GameActivity.this, Manifest.permission.CAMERA) != 0) {
                                    ActivityCompat.requestPermissions(GameActivity.this, PERMISSIONS_CAMERA, 1111);
                                } else {
