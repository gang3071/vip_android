...
//import com.timego.calculcator.databinding.ActivityMain2GameGeckoBinding;
//
...
//
//        getWindow().setNavigationBarColor(Color.parseColor(MainActivity.getString(GameGeckoActivity.this, "style_color", "#000000")));
//        getWindow().getDecorView().setBackgroundColor(Color.parseColor(MainActivity.getString(GameGeckoActivity.this, "windows_color", "#000000")));
