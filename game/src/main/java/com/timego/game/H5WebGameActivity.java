...
import com.timego.game.databinding.ActivityH5WebGameBinding;
...
public class H5WebGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setNavigationBarColor(Color.parseColor(GameActivity.getString(H5WebGameActivity.this, "style_color", "#000000")));
        getWindow().getDecorView().setBackgroundColor(Color.parseColor(GameActivity.getString(H5WebGameActivity.this, "windows_color", "#000000")));
