...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setNavigationBarColor(Color.parseColor(getString(GameActivity.this, "style_color", "#000000")));
        getWindow().getDecorView().setBackgroundColor(Color.parseColor(getString(GameActivity.this, "windows_color", "#000000")));
